...
ThresholdScanResult = sys.argv[2]

datafileTDAC2 = sys.argv[3]
datafileTDAC4 = sys.argv[4]
datafileTDAC6 = sys.argv[5]
datafileTDAC9 = sys.argv[6]
datafileTDAC11 = sys.argv[7]
datafileTDAC14 = sys.argv[8]
...
TDAC_value_dic_result = {}
Threshold_value_dic_result = {}
Sigma_value_dic_result = {}
Chi2_value_dic_result = {}
Scurve_plot_dic_result = {}
Data_pointsX_dic_result = {}
Data_pointsY_dic_result = {}
DIC_AnalyseThresholdScan_result = {}

DIC_AnalyseThresholdScan_result = AnalyseThresholdScan(ThresholdScanResult)

TDAC_value_dic_result = DIC_AnalyseThresholdScan_result[0]
Threshold_value_dic_result = DIC_AnalyseThresholdScan_result[1]
Sigma_value_dic_result = DIC_AnalyseThresholdScan_result[2]
Chi2_value_dic_result = DIC_AnalyseThresholdScan_result[3]
Scurve_plot_dic_result = DIC_AnalyseThresholdScan_result[4]
Data_pointsX_dic_result = DIC_AnalyseThresholdScan_result[5]
Data_pointsY_dic_result = DIC_AnalyseThresholdScan_result[6]



Correlation_plot = TH2F("Correlation_plot", "Correlation plot;Result;Expected;Threshold [e]",50,0,2000,50,0,2000)
Correlation_plot_2Dmap = TH2F("Correlation_plot_2Dmap", "2D correlation;#Row;#Col;Difference en percentage [e]",24,0,24, 36,12,48)



for r in range(0,24):
	for c in range (12,48):
		Expected_Threshold_value = AllExpectThresh_dic ["r"+str(r)+"_c"+str(c)+""]
		Result_Threshold_value = Threshold_value_dic_result ["r"+str(r)+"_c"+str(c)+""]
		Diff_Threshold = Expected_Threshold_value - Result_Threshold_value
		Diff_Threshold_percentage = (Diff_Threshold / (Expected_Threshold_value + 1.)) * 100
		Diff_Threshold_percentage_arrondi = int(Decimal(str(round(Diff_Threshold_percentage,0))))
		
		
		Correlation_plot.Fill(Result_Threshold_value,Expected_Threshold_value)
		Correlation_plot_2Dmap.Fill(r,c,Diff_Threshold)
...
Correlation_plot_2Dmap.SetTitleOffset(1.3,"z")
...
#CanvCorrelation2Dmap = ROOT.TCanvas("Correlation2Dmap","Correlation 2D map",800,600)
#ROOT.SetOwnership(CanvCorrelation2Dmap,False) # TODO: DOESN'T WORK...		
#Correlation_plot_2Dmap.Draw("colz")
#gPad.Update()

CanvCorrelation.Write()
Correlation_plot.Write()
Correlation_plot_2Dmap.Write()
#CanvCorrelation2Dmap.Write()
